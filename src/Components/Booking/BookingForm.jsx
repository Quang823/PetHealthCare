...
//                             {slots.map((slot) => {
//                                 const isBooked = bookedSlots[selectedDoctor]?.includes(slot.slot.slotId.toString());
//                                 return (
//                                     <button
//                                         key={slot.slot.slotId}
//                                         className={`slot-button ${isBooked ? 'booked' : ''} ${selectedSlot === slot.slot.slotId ? 'selected' : ''}`}
